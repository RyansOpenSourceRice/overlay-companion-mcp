    ...
    def start(self):
        ...
        response = self.send_request(
            "initialize",
            {
                ...
                "capabilities": {},
                "clientInfo": {"name": "gui-test-client", "version": "1.0.0"},
            },
        )
...
def test_mouse_click(client):
    ...
    result = client.call_tool("click_at", {"x": 300, "y": 150, "button": "left"})
...
def test_keyboard_input(client):
    ...
    result = client.call_tool("type_text", {"text": "Hello from MCP GUI Test!"})
...
def test_clipboard_operations(client):
    ...
    set_result = client.call_tool("set_clipboard", {"content": test_text})
...
def test_remove_overlay(client):
    ...
    result = client.call_tool("remove_overlay", {"overlayId": "test_text_overlay"})
...
def main():
    ...
    try:
        ...
        log(
            "   1. Connect to VNC: vnc://localhost:5900 (password: vncpass)",
            Colors.BLUE,
        )
