        ...
        if response.status_code == 200:
            ...
            if reanchor_result and 'result' in reanchor_result:
                ...
                if 'content' in result_data and result_data['content']:
                    ...
                    print(f"   📍 Old Position: ({reanchor_info['old_position']['x']}, {reanchor_info['old_position']['y']})")
                    print(f"   📍 New Position: ({reanchor_info['new_position']['x']}, {reanchor_info['new_position']['y']})")
                    print(f"   🖥️ Monitor: {reanchor_info.get('monitor_name')} (index {reanchor_info.get('monitor_index')})")
        ...
        if response.status_code == 200:
            ...
            if reanchor_result and 'result' in reanchor_result:
                ...
                if 'content' in result_data and result_data['content']:
                    ...
                    print(f"   📍 Actual Position: ({reanchor_info['new_position']['x']}, {reanchor_info['new_position']['y']})")
                    print(f"   🔒 Clamped: {reanchor_info.get('clamped', False)}")
                ...
                print("⚠️ Boundary clamping test returned 200 but couldn't parse response")
                return False
        else:
