...
if [[ ! "$response" =~ ^[Yy]$ ]]; then
    ...
    echo "curl -fsSL https://raw.githubusercontent.com/RyansOpenSourceRice/overlay-companion-mcp/main/scripts/vm-setup-kasmvnc.sh | bash"
    exit 0
fi
...
show_connection_info() {
    ...
    echo "2. Run the container setup: curl -fsSL https://raw.githubusercontent.com/RyansOpenSourceRice/overlay-companion-mcp/main/scripts/host-setup.sh | bash"
